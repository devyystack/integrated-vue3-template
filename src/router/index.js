...
const constantRoutes = [
    ...
    {
      path: '/:slug',
      component: () => import('../views/TownHall.vue'),
      children: [
        {
          path: '/:slug/proposal',
          component: () => import('../views/townhall/Proposal.vue'),
          hidden: true,
        },
        {
          path: '/:slug/announcement',
          component: () => import('../views/townhall/Announcement.vue'),
          hidden: true,
        },
        {
          path: '/:slug/details',
          component: () => import('../views/townhall/Details.vue'),
          hidden: true,
        },
      ]
    },
